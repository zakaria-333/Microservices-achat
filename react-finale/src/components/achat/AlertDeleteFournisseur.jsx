...
const AlertDeletFournisseur = ({ text1, text2, id, onSuccess }) => {
  ...
  const handleDelete = async () => {
    try {
      console.log(id)
      const response = await axios.delete(`/api/demande/fournisseur/delete/${id}`, {
        headers: {
...
export default AlertDeletFournisseur
